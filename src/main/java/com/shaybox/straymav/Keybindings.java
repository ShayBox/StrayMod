...
class Keybindings {
	...
	static KeyBinding give = new KeyBinding("Give chance cube", Keyboard.KEY_LEFT, Main.MOD_NAME + "Manual");
	static KeyBinding bat = new KeyBinding("Spawn bat", Keyboard.KEY_RIGHT, Main.MOD_NAME + "Manual");
